...
[![Whitepaper](https://img.shields.io/badge/Whitepaper-v1.0-1e3c72?style=flat-square&logo=read-the-docs&logoColor=white)](https://github.com/ekwenetwork/whitepaper)
[![Bitcoin L2](https://img.shields.io/badge/Anchored%20to-Bitcoin%20L2-f7931a?style=flat-square&logo=bitcoin&logoColor=white)](https://ekwe.network)
...
|---|---|---|
| **Edge Relay** | BLE · Wi-Fi Direct · LoRaWAN | Store-and-forward mesh routing |
| **Execution** | zkVM (RISC Zero) | Verifiable on-device computation |
| **Settlement** | Bitcoin Layer-2 (BitVM2) | Trust-minimized financial finality |
| **Incentives** | $EKWE token · BTC mining | Aligned rewards for infrastructure providers |
| **Hardware** | EkweBox · Smartbox | Physical edge nodes for always-on relaying |
...
|---|---|---|
| **Foundation** | v0.1 | Protocol specification · Edge Agent prototype (Rust) |
| **Tokenomics** | v0.2 | $EKWE token design · staking model |
| **Hardware** | v0.3 | EkweBox · Smartbox with Interaction Combinator ASIC |
| **Developer** | v0.4 | App SDKs (Android/iOS) · developer portal · dApp APIs |
| **Testnet** | v0.5 | Public testnet · rural and urban pilot deployments |
| **Mainnet** | v1.0 | zk-Execution engine · Bitcoin L2 rollup · EkwePay launch |
| **Scale** | v2.0 | Multi-region sync bridges · emergency lanes · cross-chain |
...
|---|---|
| [`whitepaper`](https://github.com/ekwenetwork/whitepaper) | Ekwe Protocol Whitepaper (v1.0, February 2026) |
...
| | |
|---|---|
| **Protocol domain** | [ekwe.network](https://ekwe.network) |
| **Flagship product** | [ekwepay.com](https://ekwepay.com) |
| **Parent company** | Nzagha Ventures PCV |
| **Whitepaper** | [Read the Whitepaper →](https://github.com/ekwenetwork/whitepaper) |
...
*Ekwe Technologies Limited · A subsidiary of Nzagha Ventures PCV*
